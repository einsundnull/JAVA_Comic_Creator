...
public class SvgTileViewerApp {
	...
	private void createAndShowUI() {
		...
		scenePanel = new JPanel(null); // Freie Positionierung
		scenePanel.setBackground(Color.LIGHT_GRAY);
	...
	private void loadFolderFiles(File folder) {
		SwingUtilities.invokeLater(() -> {
			...
			scenePanel.setPreferredSize(new Dimension(2000, 2000)); // groß genug für Drag
	...
	private JPanel createThumbnailRow(File file, boolean withCheckbox, boolean withName) {
		...
		thumb.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				...
				// Holen Sie sich das CustomImageTile, das zu dieser Datei gehört
