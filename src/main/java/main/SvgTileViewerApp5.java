...
public class SvgTileViewerApp5 {
    ...
    private void createAndShowUI() {
        ...
        tilePanel.add(createThumbnailRow(dummyFile, true, true));
     ...
     // Panel für ausgewählte Dateien rechts
        selectedPanel = new JPanel();
//        selectedPanel.setLayout(new WrapLayout(FlowLayout.LEFT, 10, 10));
        selectedPanel.setLayout(new BoxLayout(selectedPanel, BoxLayout.Y_AXIS));

        selectedPanel.setBackground(Color.LIGHT_GRAY);
        selectedPanel.add(createThumbnailRow(dummyFile, false,false));
        ...
        frame.add(selectedScrollPane, BorderLayout.EAST);
